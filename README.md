<div align="center">A dashboard for a company in the pharmaceutical industry following best practices</div>
...
<dl>
  ...
  <dd>Enjoy the best UX (User eXperience)</dd>

  <dt>Dynamic webpages</dt>
...
1. Clone this repo using `git clone https://github.com/HITISINHA/Gulati Pharma.git`
2. Move to the appropriate directory: `cd Gulati Pharma`.<br />
3. Run `yarn` or `npm install` to install dependencies.<br />
4. Run `npm start` to see the example app at `http://localhost:3000`.

Now you're ready to build this beautiful Application!
